...
public class Fragment_Details extends Fragment implements OnMapReadyCallback {
    ...
    private ImageView arrow_down,image_today;
    private TextView tv_today,tv_to;
    ...
    private void initView(View view) {
        ...
        image_today = view.findViewById(R.id.image_today);
    ...
    private void getPlaceDetails(PlaceModel placeModel) {
        ...
        Api.getService("https://maps.googleapis.com/maps/api/")
                .getPlaceDetails(placeModel.getPlace_id(),fields,current_language,"AIzaSyArjmbYWTWZhDFFtPOLRLKYwjtBDkOEGrY")
    ...
    private void updateHoursUI(PlaceDetailsModel body) {
        ...
        if (body.getResult().getOpening_hours()!=null)
        {
            ...
            image_today.setVisibility(View.VISIBLE);
